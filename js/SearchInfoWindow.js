       ...
       */
        ...
        _adjustPosition: function(poi){
            ...
            if(this._marker){
                ...
                this.container.style.bottom = -(pixel.y - this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height) - this._marker.getOffset().height + 2 +12 + "px";
                ...
                this.container.style.bottom = -(pixel.y - this._opts.offset.height)+12 + "px";
